...
{
    private static final long serialVersionUID = -2515866874985841788L;
     ...
     * 
     * @param label
     *            the label to create if the node does not exist.
     * @return the node added.
     * @throws GraphConstraintException
     *             if there was a problem with adding this node.
     */
    public Node addNode(String label) throws GraphConstraintException
    {
     ...
     * @return the node added.
     * @throws GraphConstraintException
     *             if there is a problem with adding this node.
     */
    public Node addNode(Node node) throws GraphConstraintException
    {
        if (node == null)
        {
    ...
    public Edge addEdge(Edge edge) throws GraphConstraintException
    {
    ...
    public Edge addEdge(Node start, Node end) throws GraphConstraintException
    {
    ...
    public Edge addEdge(String startLabel, String endLabel) throws GraphConstraintException
    {
    ...
    /**
     * Generates an internal Key for the edge, used by the internal <code>edgeMap</code> field.
     * 
     * @param start
     *            the start node.
     * @param end
    ...
    protected void assertGraphConstraints(Node node) throws GraphConstraintException
    {
        // Ignore
    }
